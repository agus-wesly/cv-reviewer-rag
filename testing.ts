...
async function main() {
    // const aspects: Array<AspectKey> = ["education", "contactInformation"];
    const aspects: Array<string> = ["Education", "Skills"];
    ...
    aspects.forEach(async (aspect) => {
        ...
        // if (resp) {
        //     console.log(`Response for aspect ${aspect} is ${resp.analysis}`);
        // }
    });
}
